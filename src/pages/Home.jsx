    ...
    >
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* Half map · Half aerial drone */}
          <div
            className={`overflow-hidden rounded-3xl border shadow-2xl grid grid-cols-1 md:grid-cols-2 ${
          ...
          >
            ...
            <iframe
              ...
              className="h-[300px] sm:h-[420px] md:h-[480px] w-full"
              loading="lazy"
              referrerPolicy="no-referrer-when-downgrade"
            />
            {/* Right — Aerial drone shot */}
            <div className="relative h-[300px] sm:h-[420px] md:h-[480px] overflow-hidden">
              <img
                src={aerialDroneShot}
      ...
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          ...
          {/* Infinite scrolling slider — duplicated for seamless loop */}
          <div className="overflow-hidden relative">
            {/* Fade edges */}
            <div className={`pointer-events-none absolute inset-y-0 left-0 w-24 z-10 ${isDarkMode ? "bg-linear-to-r from-[#0F0D0A]" : "bg-linear-to-r from-[#EAF3EA]"}`} />
            <div className={`pointer-events-none absolute inset-y-0 right-0 w-24 z-10 ${isDarkMode ? "bg-linear-to-l from-[#0F0D0A]" : "bg-linear-to-l from-[#EAF3EA]"}`} />

            <div className="reviews-track gap-5 pb-2">
              {[...TESTIMONIALS, ...TESTIMONIALS].map((review, index) => (
                <div
                  key={`${review.name}-${index}`}
                  className={`flex-shrink-0 flex flex-col rounded-2xl border p-5 w-[320px] md:w-[360px] mx-3 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl ${
                    isDarkMode
