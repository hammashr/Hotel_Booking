  ...
  useEffect(() => {
    ...
    const initWidget = () => {
      ...
      initScript.innerHTML = `
        var searchwidget = new SearchWidget('searchwidget', 'https://book.hostfully.com/the-tiny-escape/search', {"lang":"US","fields":["location","checkIn","checkOut","guests"],"maximumGuests":30,"daysBetweenDates":7,"openInNewTab":false,"backgroundColorButton":"#0c7420","colorButton":"#ffffff","uid":"6ccc7df6-fe56-4468-8612-977c9c73e66d"});
      `;
