    ...
    >
      ...
      <section className={`py-16 ${isDarkMode ? 'bg-[#141A1F]' : 'bg-[#F3F8F3]'}`}>
        <div className="container mx-auto px-4">
          <div className={`rounded-3xl p-6 md:p-8 border grid lg:grid-cols-[1fr_auto] gap-8 items-start backdrop-blur-md ${
            ...
            <div style={{ height: '180px', width: '280px', overflow: 'hidden', borderRadius: '1rem', flexShrink: 0 }}>
              <img
                src={cafeOne}
